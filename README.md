...
6. **Location Overlay:** Display your current coordinates and direction on-screen via a toggleable HUD (`/bm location`). (*Temporarily disabled for compatibility fixes*)
